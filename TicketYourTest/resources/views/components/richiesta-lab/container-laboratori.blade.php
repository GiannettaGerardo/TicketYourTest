<div class="row effettohover w-50 ml-0 mr-0 containerLab justify-content-start mb-2" id="{{$id}}">
    <div class="col-xs-10 col-md-11">
        <div>
            ...
            <div class="mic-info">
                ...
                <form class="row justify-content-around" method="post" action="{{route('convenziona.laboratorio')}}">
                    ...
                    <div class="action">
                        <button type="submit" class="btn btn-success btn-xs" title="Approved" id="submitButton{{$id}}">
