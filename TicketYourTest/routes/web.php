...
Route::post('/questionario-anamnesi/{token}', [QuestionarioAnamnesiController::class, 'compilaQuestionario'])->middleware('questionario_compilato_visualizzabile')->name('compila.questionario.anamnesi');
Route::post('/visualizza-questionario-anamnesi', [QuestionarioAnamnesiController::class, 'questionarioCompilato'])->middleware('laboratorio_registrato')->name('visualizza.questionario.anamnesi');
